...
namespace LINQtoCSV.Tests
{
	...
	public class CsvContextReadTests : Test
	{
		...
		public void GoodFileNoSeparatorCharUseOutputFormatForParsingUSEnglish()
		{
			...
			string testInput =
				"AAAAAAAA34.18405/23/08" + Environment.NewLine +
				"BBBBBBBB10.31105/12/12" + Environment.NewLine +
...
and a quoted ""string"""
		...
		public void GoodFileTabDelimitedNoNamesInFirstLineNLnl()
		{
			...
			var expected = new[] {
				...
				new ProductData {
					name = "mouse trap", weight = 45E-5, startDate = new DateTime(1985, 1, 2), launchTime = new DateTime(1988, 8, 7, 0, 0, 0),
					nbrAvailable = 0, onsale = false, shopsAvailable = @"This field has" + Environment.NewLine + "a newline", hexProductCode = 256, retailPrice = 78300M,
					description = @"This field has quotes(""), and" + Environment.NewLine +
						"two newlines" + Environment.NewLine +
						"and a quoted \"string\""
				},
				new ProductData {
					name = "dog house", weight = 45230990, startDate = new DateTime(2004, 2, 29), launchTime = default(DateTime),
